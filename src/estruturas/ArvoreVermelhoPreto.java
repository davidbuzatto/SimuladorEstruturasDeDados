...
public class ArvoreVermelhoPreto<Tipo extends Comparable<? super Tipo>> 
    ...
    public String toString() {
        ...
        if ( !estaVazia() ) {
            ...
            for ( No<Tipo> no : PercursosArvoreVermelhoPreto.percorrer( this, TipoPercursoArvores.EM_ORDEM ) ) {
     ...
     */
    @Override
    public Iterator<No<Tipo>> iterator() {
