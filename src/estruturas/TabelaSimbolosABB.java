...
/**
 * Implementação de uma tabela de símbolos usando árvore binária de busca chave/valor.
 * 
 * @author David Buzatto
 */
public class TabelaSimbolosABB<TipoChave extends Comparable<? super TipoChave>, TipoValor> implements 
        Iterable<TabelaSimbolosABB<TipoChave, TipoValor>.Entrada<TipoChave, TipoValor>> {
    ...
    private ArvoreBinariaBuscaCV<TipoChave, TipoValor> abb;
    
    /**
     * Constrói uma tabela de símbolos vazia.
     */
    public TabelaSimbolosABB() {
        abb = new ArvoreBinariaBuscaCV<>();
    }
    ...
    public List<TipoChave> chaves() {
        ...
        for ( ArvoreBinariaBuscaCV<TipoChave, TipoValor>.No<TipoChave, TipoValor> e : abb ) {
            chaves.add( e.chave );
        }
