...
public class PercursosArvoreVermelhoPreto {
     ...
     */
    public static <TipoChave extends Comparable<? super TipoChave>, TipoValor> Iterable<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> percorrer( 
            ArvoreVermelhoPreto<TipoChave, TipoValor> avp, TipoPercursoArvores tipo ) {
        
        List<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> elementos = new ArrayList<>();
    ...
    private static <TipoChave extends Comparable<? super TipoChave>, TipoValor> void preOrdem( 
            ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor> no, 
            List<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> elementos ) {
    ...
    private static <TipoChave extends Comparable<? super TipoChave>, TipoValor> void emNivel( 
        ...
        if ( no != null ) {
            ...
            Fila<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> fila = new Fila<>();
            fila.enfileirar( no );

            while ( !fila.estaVazia() ) {

                ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor> atual = fila.desenfileirar();
                elementos.add( atual );
    ...
    private static <TipoChave extends Comparable<? super TipoChave>, TipoValor> void emNivelInverso( 
        ...
        if ( no != null ) {
            ...
            Fila<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> fila = new Fila<>();
            Pilha<ArvoreVermelhoPreto<TipoChave, TipoValor>.No<TipoChave, TipoValor>> pilha = new Pilha<>();
            fila.enfileirar( no );
