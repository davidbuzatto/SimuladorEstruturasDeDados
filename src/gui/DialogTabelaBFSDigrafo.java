 ...
 */
public class DialogTabelaBFSDigrafo extends javax.swing.JDialog {

    private Digrafo<Integer> digrafo;
    private DigrafoAnotado digrafoAnotado;
     ...
     */
    public DialogTabelaBFSDigrafo( java.awt.Frame parent, boolean modal, 
            Digrafo<Integer> digrafo, DigrafoAnotado digrafoAnt, BuscaLargura<Integer> bfs ) {
        
        super( parent, modal );
        initComponents();
        
        this.digrafo = digrafo;
        this.digrafoAnotado = digrafoAnt;
        this.bfs = bfs;
