...
/**
 * Classe utilizada no simulador de heap máximo.
 * 
 * Esta classe processa um heap máximo, gerando os dados
 * necessários ao simulador em cada nó. Esta classe gera um clone do heap máximo.
 * 
 * @author David Buzatto
 */
public class HeapMaximoAnotado<Tipo extends Comparable<? super Tipo>> {
        
    /*
     * Classe interna que representa os nós do heap máximo anotado.
    ...
    /**
     * Cria um heap máximo anotado com base em um heap máximo passado.
     * @param hm Heap máximo que será usada como base.
     */
    public HeapMaximoAnotado( HeapMaximo<Tipo> hm ) {
        copiar( hm );
        processar( raiz, null );
    }

    /**
     * Copia os dados do heap máximo, criando uma outra árvore
     * com os mesmos dados. É o primeiro passo da construção.
     * 
     * @param hm Heap máximo original.
     */
    private void copiar( HeapMaximo<Tipo> hm ) {
