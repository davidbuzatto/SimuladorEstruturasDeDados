...
/**
 * Heap mínimo desenhável.
 * 
 * @author David Buzatto
 */
public class HeapMinimoDesenhavel<Tipo extends Comparable<? super Tipo>> implements Desenhavel {
    
    private HeapMinimo<Tipo> hm;
    private PainelDesenho painel;
    private HeapMinimoAnotado<Tipo> hmAnt;
    ...
    private List<HeapMinimoAnotado<Tipo>.NoAnotado<Tipo>> listaPercurso;
    
    public HeapMinimoDesenhavel( HeapMinimo<Tipo> hm ) {
        this.hm = hm;
        diametroNos = 30;
    ...
    private void calcularNovoTamanoPainelEPosicaoNos() {
        ...
        if ( hmAnt != null && hmAnt.getRaiz() != null ) {
            ...
            for ( HeapMinimoAnotado<Tipo>.NoAnotado<Tipo> no : hmAnt.percorrer( TipoPercursoArvores.EM_ORDEM ) ) {
    ...
    public void setAbbAnt( HeapMinimoAnotado<Tipo> hmAnt ) {
        this.hmAnt = hmAnt;
    }
